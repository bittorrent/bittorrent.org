...
- Complete downloading of pieces, that is, from `sample-file0.txt` to last piece of that file.
- Match the hash values of pieces.
- It announces that, it has the completed the downloading of the piece to all of its peers.
