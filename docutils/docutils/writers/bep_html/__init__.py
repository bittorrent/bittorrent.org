...
class Writer(html4css1.Writer):
    ...
    settings_spec = html4css1.Writer.settings_spec + (
        'BEP/HTML-Specific Options',
        'For the BEP/HTML writer, the default value for the --stylesheet-path '
        ...
        (('Python\'s home URL.  Default is "http://www.python.org".',
         ...
         ('Home URL prefix for BEPs.  Default is "." (current directory).',
          ['--bep-home'],
          {'default': '.', 'metavar': '<URL>'}),
         # For testing.
    ...
    config_section = 'bep_html writer'
	...
	subs['bthome'] = bthome
        ...
        try:
            subs['bepnum'] = '%04i' % int(self.bepnum)
        except ValueError:
            subs['bepnum'] = bepnum
