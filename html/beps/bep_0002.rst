...
in BEP 1 [1]_, this should make it easy for you to conform your own
...
This document was derived heavily from `PEP-0012`_.  In many places
text was simply copied and modified.  Although the `PEP-0012`_ text
...
editors <editor@bittorrent.org> or the BitTorrent mailing list
...
.. [1] BEP 1, BEP Purpose and Guidelines, Harrison
   (http://www.bittorrent.org/beps/bep_0001)
