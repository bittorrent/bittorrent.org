...
1. The user needs to configure his/her bittorrent client, it won't
   work out-of-the-box.
2. The user needs to know his/her internet connection's upload
   capacity. This capacity may change, especially on laptops that
   may connect to a large number of different networks.
3. The headroom of 20% is arbitrary and wastes bandwidth. Whenever
...
This is the protcol version. The current version is 1.
...
*describe the initial connection setup sequence*
